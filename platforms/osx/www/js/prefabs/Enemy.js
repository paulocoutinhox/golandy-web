...
GameApp.Enemy = function (game_state, name, position, properties) {
	"use strict";
...
GameApp.Enemy.prototype = Object.create(GameApp.Prefab.prototype);
GameApp.Enemy.prototype.constructor = GameApp.Enemy;

GameApp.Enemy.prototype.update = function () {
	"use strict";
	var new_position;
...
GameApp.Enemy.prototype.switch_direction = function () {
	"use strict";
	if (this.axis === "x") {
